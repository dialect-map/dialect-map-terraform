...
resource "google_cloud_run_service" "dialect-map-public-api" {
  name     = "dialect-map-public-api"
...
resource "google_cloud_run_service_iam_binding" "dialect-map-public-api-access" {
  project  = var.project_id
  location = var.project_region
  service  = google_cloud_run_service.dialect-map-public-api.name
